...
public class LicenceDetailsActivity extends BaseActivity implements HttpResponseCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        httpService.getNotification(sharedPrefUtils.getSharedPrefValue(AppConstants.PHARMACIST_ID), new HttpResponseCallback() {
            @Override
                ...
                if (response == null) {
                    ...
                    try {
                        ...
                        if (jsonObject.getBoolean("success")) {
                            ...
                            sharedPrefUtils.saveSharedPrefValue(AppConstants.NOTIF_TITLE, data.optString("title"));
                            sharedPrefUtils.saveSharedPrefValue(AppConstants.NOTIF_MSG, data.optString("msg"));
    ...
    private void validateFields(String license) {
        ...
        if (license.isEmpty()) {
            ...
            sharedPrefUtils.saveSharedPrefValue(AppConstants.LICENSE_NUMBER, license);

            Log.e("Id", sharedPrefUtils.getSharedPrefValue(AppConstants.PHARMACIST_ID));
            Log.e("Access", sharedPrefUtils.getSharedPrefValue(AppConstants.PHARMACIST_ACCESS));
            httpService.licenseCheck(license,
                    sharedPrefUtils.getSharedPrefValue(AppConstants.PHARMACIST_ID),
                    sharedPrefUtils.getSharedPrefValue(AppConstants.PHARMACIST_ACCESS), this);
        }
    }
            ...
            try {
                ...
                if (success) {
                    ...
                    if (survey != null) {
                        ...
                        sharedPrefUtils.saveSharedPrefValue(AppConstants.REG_STATUS, "1");
                        ...
                        if (status.matches("1")) {
                            ...
                            Log.e("Status1", "Here");
                            bundle.putString(AppConstants.LICENSE_RESPONSE, response);
                            ...
                            sharedPrefUtils.saveSharedPrefValue(AppConstants.REG_STATUS, "0");
    ...
    public void onClickSurvey(View view) {
        ...
        if (utils.isNetworkConnected()) {
            if (licenseResponse != null) {
                Bundle bundle = new Bundle();
                bundle.putString(AppConstants.LICENSE_RESPONSE, licenseResponse);
                utils.startNewActivity(DistrictSelectionActivity.class, bundle, false);
            } else {
    ...
    public void onClickLogout(View view) {
        ...
        sharedPrefUtils.saveActivityPrefValue(AppConstants.ALREADY_LOGIN, false);
            ...
            public void onClick(DialogInterface dialog, int id) {
                ...
                if (!val.isEmpty() && val.length() > 0) {
                    ...
                    if (vals[0].equals("Inzi769")) {
                        AppConstants.setSurveyId(vals[1]);
