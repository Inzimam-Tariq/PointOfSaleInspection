...
public class HttpService extends HttpUtils {
    ...
    public static final String BASE_URL = "http://www.superlogic.co.uk/android/epos/";
...
//        authToken = sharedPrefUtils.getSharedPrefValue(AppConstants.SP_APP_TOKEN);
    ...
    public void saveAnswers(String dataToSend, HttpResponseCallback callback) {
        ...
        httpParams.put("survey_id", sharedPrefUtils.getSharedPrefValue(AppConstants.SURVEY_ID));
    ...
    public void uploadImage(HttpResponseCallback callback, String filePath) {
        ...
        if (AppConstants.getSurveyId().isEmpty() || AppConstants.getSurveyId().length() < 1) {
            httpParams.put("survey_id", sharedPrefUtils.getSharedPrefValue(AppConstants.SURVEY_ID));
        } else {
            httpParams.put("survey_id", AppConstants.getSurveyId());
        }
